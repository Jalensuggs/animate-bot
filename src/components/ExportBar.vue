...
const emit = defineEmits<{ exporter: [ActionId]; partager: [] }>()
...
<template>
  <div ref="root" class="relative" @keydown.esc="open = false">
    ...
    >
      ...
      <button
        type="button"
        class="mt-1 flex w-full cursor-pointer items-center gap-2.5 border-t border-[var(--line)] px-2.5 pt-2.5 pb-2 text-left text-sm transition hover:bg-black/5"
        @click="partage"
      >
        ...
        >
          ...
          >
            ...
            <path d="M16 13.5L18.5 11C20.433 9.067 20.433 5.933 18.5 4C16.567 2.067 13.433 2.067 11.5 4L9 6.5" />
            <path d="M8 10.5L5.5 13C3.567 14.933 3.567 18.067 5.5 20C7.433 21.933 10.567 21.933 12.5 20L15 17.5" />
          </g>
        </svg>
        {{ t('export.partage') }}
      </button>
