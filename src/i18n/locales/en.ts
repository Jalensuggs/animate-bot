...
const en: typeof fr = {
  app: {
    name: 'Animate Bot',
    title: 'Animate Bot — animated SVG avatar',
    botAria: 'Animated Animate Bot avatar'
  },
  ...
  game: {
    title: 'Animate Bot game',
    exit: 'Exit game',
    level: 'Level {n}',
    lives: 'Lives',
    collectibles: 'Sparks',
    chooseLevel: 'Choose a level',
    scene: 'Level {level} of Animate Bot',
    pause: 'Pause',
    paused: 'Paused',
    resume: 'Resume',
    completed: 'Level complete',
    perfect: 'You collected every spark',
    missed: '{n} spark left | {n} sparks left',
    next: 'Next level',
    finish: 'Back to the studio',
    replay: 'Play again',
    gameover: 'Game over',
    tryAgain: 'The bot is ready to try again',
    restart: 'Restart',
    left: 'Move left',
    right: 'Move right',
    jump: 'Jump',
    ...
    skill_orbit: 'Orbit',
    ability: 'Power',
    ability_none: 'none, just move and jump',
    ability_dash: 'speed dash',
    ability_shield: 'hexagonal shield',
    ability_burst: 'burst',
    ability_orbit: 'orbital activation',
    level1: 'First jumps',
    level2: 'Secret passage',
    level3: 'Live wire',
    level4: 'Orbits and bursts',
    level5: 'The big mix',
    hint1: 'Move, jump and collect the three sparks.',
    hint2: 'The capsule body slips beneath low ceilings.',
    hint3: 'Use your power to cross the long danger zones.',
    hint4: 'Activate the rings, then burst through marked walls.',
    hint5: 'Every move matters. The shield absorbs one hit.'
  },
