...
export default {
  app: {
     ...
     */
    name: 'Animate Bot',
    title: 'Animate Bot — avatar SVG animé',
    botAria: 'Avatar Animate Bot animé'
  },
  ...
  game: {
    title: 'Jeu Animate Bot',
    exit: "Quitter le jeu",
    level: 'Niveau {n}',
    lives: 'Vies',
    collectibles: 'Étincelles',
    chooseLevel: 'Choisir un niveau',
    scene: 'Niveau {level} du jeu Animate Bot',
    pause: 'Mettre en pause',
    paused: 'Pause',
    resume: 'Reprendre',
    completed: 'Niveau terminé',
    perfect: 'Toutes les étincelles sont à toi',
    missed: 'Il reste {n} étincelle | Il reste {n} étincelles',
    next: 'Niveau suivant',
    finish: "Retourner à l'atelier",
    replay: 'Rejouer',
    gameover: 'Partie terminée',
    tryAgain: 'Le bot est prêt à repartir',
    restart: 'Recommencer',
    left: 'Aller à gauche',
    ...
    skill: 'Pouvoir',
    ability: 'Pouvoir',
    ability_none: 'aucun, avance et saute',
    ability_dash: 'élan rapide',
    ability_shield: 'bouclier hexagonal',
    ability_burst: 'éclatement',
    ability_orbit: 'activation orbitale',
    level1: 'Premiers bonds',
    level2: 'Passage secret',
    level3: 'Ligne vive',
    level4: 'Orbites et éclats',
    level5: 'Grand mélange',
    hint1: 'Avance, saute et ramasse les trois étincelles.',
    hint2: 'Le corps capsule se glisse sous les plafonds bas.',
    hint3: 'Utilise ton pouvoir pour traverser les longues zones de danger.',
    hint4: 'Active les anneaux, puis fais éclater les murs marqués.',
    hint5: 'Tous les réflexes comptent. Le bouclier absorbe un choc.'
  },
  ...
  export: {
    ...
    partage: 'Copier le lien de partage',
    done: 'Exporté',
    copied: 'Copié',
